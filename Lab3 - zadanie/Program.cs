...
namespace Lab3zadanie
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            var connectionString = builder.Configuration.GetConnectionString("Lab3___zadanieContextConnection") ?? throw new InvalidOperationException("Connection string 'Lab3___zadanieContextConnection' not found.");
